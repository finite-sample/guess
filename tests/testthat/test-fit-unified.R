...
test_that("fit_model validates inputs correctly", {
  ...
  # Test NULL inputs
  expect_error(
    fit_model(NULL, test_data$pst_test, c(0.25, 0.25), matrix(0.1, 3, 2)),
    "Must be of type 'data.frame'"
  )
  expect_error(
    fit_model(test_data$pre_test, NULL, c(0.25, 0.25), matrix(0.1, 3, 2)),
    "Must be of type 'data.frame'"
  )
  expect_error(
    fit_model(test_data$pre_test, test_data$pst_test, NULL, matrix(0.1, 3, 2)),
    "g must be provided"
  )
  expect_error(
    fit_model(test_data$pre_test, test_data$pst_test, c(0.25, 0.25), NULL),
  ...
  expect_error(
    fit_model(test_data$pre_test, wrong_pst, c(0.25, 0.25), matrix(0.1, 3, 2)),
